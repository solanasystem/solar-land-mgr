...
+'.gacho-panel{position:fixed;right:12px;bottom:12px;width:252px;z-index:1200;background:rgba(13,17,23,.95);border:1px solid #30363d;border-radius:10px;color:#e6edf3;font-size:12px;box-shadow:0 6px 24px rgba(0,0,0,.45);}'
...
+'.gacho-row{display:flex;align-items:center;gap:6px;padding:4px 4px;border-radius:6px;}'
...
+'.gacho-name{flex:1;cursor:pointer;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}'
