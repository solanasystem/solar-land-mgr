...
function boot(){var m=getMap();if(!m||typeof L==='undefined'){return setTimeout(boot,250);}_fullRestoreOnce();_upgradeHandDrawnOk();injectStyle();buildPanel();ensurePane(m);render();applyBase0();try{loadDbJudgments();setTimeout(loadDbJudgments,2500);}catch(_){}m.on('zoomend',updateAreaLabels);updateAreaLabels();
