...
window.CLIENT_FUNCTIONS = {
  ...
  registry: {
    ...
    'case-master':    { label:'案件マスター（地権者情報）', desc:'確定納品に御社だけが読める地権者情報を暗号で記録（当社は復号不可＝運用者ブラインド）。各案件の操作欄からAI転記（登記簿アップロード）も可能', icon:'📇', url:'client-case-master.html', ready:true, accent:'#f472b6' },
